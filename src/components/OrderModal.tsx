...
// Componente ItemProgressModal simplificado
              ...
              <div className="mt-6">
                ...
                {formData.paymentTerms === 'personalizado' && (
                  <input
                    ...
                    disabled={mode === 'view'}
                    className={`w-full p-3 mt-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                      mode === 'view' ? 'bg-gray-100' : ''
                    }`}
                  />
                )}
