...
import { X, Edit, Trash2, Plus, Download, BarChart3, Settings, CheckCircle } from 'lucide-react';
...
const OrderItemsList: React.FC<OrderItemsListProps> = ({
  ...
  // Função para exportar PDF sem coluna de progresso - INTEGRADA
  const exportOrderToPDF = (orderToExport: Order) => {
    const doc = new jsPDF();
